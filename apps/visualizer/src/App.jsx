...
function App() {
    ...
    return (<main style={{ padding: '2rem', 'max-width': '720px', margin: '0 auto' }}>
      ...
      <section style={{ background: '#11131f', padding: '1.5rem', 'border-radius': '8px', border: '1px solid #1f2330' }}>
        ...
        {credentials().length === 0 && (<p style={{ color: '#64748b' }}>아직 캡처된 정보가 없습니다. QR코드로 접속 후 로그인을 시도핳보세요.</p>)}
        <div style={{ display: 'flex', 'flex-direction': 'column', gap: '0.75rem' }}>
          {credentials().map((c, i) => (<div style={{
                background: '#0b0c15',
                padding: '1rem',
                'border-radius': '6px',
                border: '1px solid #1f2330'
